$module = Get-Content .\module.json | ConvertFrom-Json
$version = $module.version
lessc "chaosos-skill.less" "chaosos-skill.css"
if (test-path .\chaosos-skill-remix.zip) {
    Remove-Item .\chaosos-skill-remix.zip
    Write-Output "Deleted old file"
}
Compress-Archive -Path .\ -DestinationPath .\chaosos-skill-remix.zip
